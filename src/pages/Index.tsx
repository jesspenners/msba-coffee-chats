      ...
      <div className="lg:ml-56">
        <div className="max-w-3xl mx-auto px-6 md:px-8">
          ...
          <Section id="thankyou">
            ...
            <MessageExample
              type="email"
              body={`Hi Alex,\n\nThank you again for taking the time to speak today. I really enjoyed hearing about your experience in ____ and appreciate the advice you shared about ____.\n\nYour suggestion to focus on ____ was especially helpful, and I plan to start working through some this week. I also appreciated learning more about ____ at ____.\n\nI'd love to stay in touch! Have a great time at the conference this weekend / great rest of your week!\n\nBest,\nJess`}
            />
          </Section>
          ...
          <Section id="tracking">
            ...
            <p className="text-muted-foreground mb-6">Tracking conversations helps you stay organized. I use <a href="https://monday.com/" target="_blank" rel="noopener noreferrer" className="text-primary underline hover:text-primary/80 font-semibold">Monday.com</a> (free), but many students use Excel or Notion.</p>
